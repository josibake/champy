...
void ReportBlockChecked(CoreChainValidationContext& context, const std::shared_ptr<const CBlock>& block, const BlockValidationState& state) LOCKS_EXCLUDED(cs_main);
