...
public:
    CoreBlockConnectionSetup(CoreBlockConnectionRuntimeInputs runtime, CoreBlockConnectionPlan connection_plan, validation::BlockConnectionBlockPosition block_position, BlockConnectionTrace& trace, bool cache_script_results);
...
private:
    ...
    validation::BlockConnectionBlockPosition m_block_position;
