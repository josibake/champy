...
class CoinBatchView final : public Consensus::SpendStateBatchView {
public:
...
BOOST_AUTO_TEST_CASE(segment_spend_join_resolves_outputs_created_by_earlier_blocks)
{
    ...
    const std::vector<CTransactionRef> block1{MakeCoinbase(), spend};
...
BOOST_AUTO_TEST_CASE(swiftsync_accumulator_cancels_spent_created_outputs)
{
    ...
    Consensus::SwiftSyncAccumulator accumulator;
