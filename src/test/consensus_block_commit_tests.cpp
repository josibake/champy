...
class InspectingBlockCommitter final : public Consensus::BlockRevertDataWriter, public Consensus::BlockSpendStateCommitter, public Consensus::BlockMetadataCommitter {
public:
