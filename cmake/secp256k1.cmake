...
function(add_secp256k1 subdir)
  ...
  get_target_interface(SECP256K1_EXTRA_CFLAGS "" sanitize_interface COMPILE_OPTIONS)
  string(STRIP "${SECP256K1_EXTRA_CFLAGS}" SECP256K1_EXTRA_CFLAGS)
  set(SECP256K1_EXTRA_CFLAGS ${SECP256K1_EXTRA_CFLAGS} CACHE STRING "" FORCE)
  get_target_interface(SECP256K1_EXTRA_LDFLAGS "" sanitize_interface LINK_OPTIONS)
  string(STRIP "${SECP256K1_EXTRA_LDFLAGS}" SECP256K1_EXTRA_LDFLAGS)
  set(SECP256K1_EXTRA_LDFLAGS ${SECP256K1_EXTRA_LDFLAGS} CACHE STRING "" FORCE)
